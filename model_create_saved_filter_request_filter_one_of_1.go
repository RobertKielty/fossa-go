...
type CreateSavedFilterRequestFilterOneOf1 struct {
	...
	// Filterable vuln ignore reason. Superset of VulnIgnoreReason that also includes the NotDistributed auto-ignore reason, which can be filtered on but never provided when ignoring or excepting an issue. 
