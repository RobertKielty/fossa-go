...
type GetReleaseGroupReleaseScans200ResponseInner struct {
	...
	RevisionScans []GetReleaseGroupReleaseScans200ResponseInnerAllOfRevisionScansInner `json:"revisionScans,omitempty"`
}
...
func (o *GetReleaseGroupReleaseScans200ResponseInner) GetRevisionScans() []GetReleaseGroupReleaseScans200ResponseInnerAllOfRevisionScansInner {
	if o == nil || IsNil(o.RevisionScans) {
		var ret []GetReleaseGroupReleaseScans200ResponseInnerAllOfRevisionScansInner
		return ret
	}
...
// SetRevisionScans gets a reference to the given []GetReleaseGroupReleaseScans200ResponseInnerAllOfRevisionScansInner and assigns it to the RevisionScans field.
