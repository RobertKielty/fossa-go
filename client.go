...
// APIClient manages communication with the FOSSA API API v4.34.100
...
type APIClient struct {
	...
	IssueOverviewAPI *IssueOverviewAPIService
	...
	OrganizationLimitsAPI *OrganizationLimitsAPIService

	OrganizationSettingsAPI *OrganizationSettingsAPIService

	PackageLabelsAPI *PackageLabelsAPIService

	PackageObservabilityAPI *PackageObservabilityAPIService

	ProjectLabelsAPI *ProjectLabelsAPIService
