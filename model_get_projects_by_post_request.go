...
type GetProjectsByPostRequest struct {
	...
	TeamId []GetIssueCountsTeamIdParameterInner `json:"teamId,omitempty"`
...
func (o *GetProjectsByPostRequest) GetTeamId() []GetIssueCountsTeamIdParameterInner {
	if o == nil || IsNil(o.TeamId) {
		var ret []GetIssueCountsTeamIdParameterInner
		return ret
	}
	return o.TeamId
}
...
// SetTeamId gets a reference to the given []GetIssueCountsTeamIdParameterInner and assigns it to the TeamId field.
