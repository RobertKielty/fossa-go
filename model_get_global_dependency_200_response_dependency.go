...
type GetGlobalDependency200ResponseDependency struct {
	...
	Issues []GetGlobalDependency200ResponseDependencyAllOfIssuesInner `json:"issues,omitempty"`
	RootProjects []GetGlobalDependency200ResponseDependencyAllOfRootProjectsInner `json:"rootProjects,omitempty"`
	...
	GroupedLicenses []GetGlobalDependency200ResponseDependencyAllOfGroupedLicensesInner `json:"groupedLicenses,omitempty"`
...
func (o *GetGlobalDependency200ResponseDependency) GetIssues() []GetGlobalDependency200ResponseDependencyAllOfIssuesInner {
	if o == nil || IsNil(o.Issues) {
		var ret []GetGlobalDependency200ResponseDependencyAllOfIssuesInner
		return ret
	}
	return o.Issues
}
...
// SetIssues gets a reference to the given []GetGlobalDependency200ResponseDependencyAllOfIssuesInner and assigns it to the Issues field.
...
func (o *GetGlobalDependency200ResponseDependency) GetRootProjects() []GetGlobalDependency200ResponseDependencyAllOfRootProjectsInner {
	if o == nil || IsNil(o.RootProjects) {
		var ret []GetGlobalDependency200ResponseDependencyAllOfRootProjectsInner
		return ret
	}
...
// SetRootProjects gets a reference to the given []GetGlobalDependency200ResponseDependencyAllOfRootProjectsInner and assigns it to the RootProjects field.
...
func (o *GetGlobalDependency200ResponseDependency) GetGroupedLicenses() []GetGlobalDependency200ResponseDependencyAllOfGroupedLicensesInner {
	if o == nil || IsNil(o.GroupedLicenses) {
		var ret []GetGlobalDependency200ResponseDependencyAllOfGroupedLicensesInner
		return ret
	}
...
// SetGroupedLicenses gets a reference to the given []GetGlobalDependency200ResponseDependencyAllOfGroupedLicensesInner and assigns it to the GroupedLicenses field.
