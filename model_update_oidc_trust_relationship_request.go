...
type UpdateOIDCTrustRelationshipRequest struct {
	...
	RequiredClaims []ListOIDCTrustRelationships200ResponseAllOfResultsInnerAllOfRequiredClaimsInner `json:"requiredClaims,omitempty"`
}
...
// SetRequiredClaims gets a reference to the given []ListOIDCTrustRelationships200ResponseAllOfResultsInnerAllOfRequiredClaimsInner and assigns it to the RequiredClaims field.
