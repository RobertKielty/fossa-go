...
> UpdateIssues200Response GetProjectDependencyCount(ctx, locator).Sources(sources).Execute()
...
func main() {
	...
	// response from `GetProjectDependencyCount`: UpdateIssues200Response
...
> UpdateIssues200Response GetReleaseGroupDependencyCount(ctx, projectGroupId, projectGroupReleaseId).Sources(sources).Execute()
...
func main() {
	...
	// response from `GetReleaseGroupDependencyCount`: UpdateIssues200Response
