...
------------ | ------------- | ------------- | -------------
**Connected** | **bool** |  | 
**StatusAvailable** | **bool** | Whether Core obtained a fossabot status for the requested scope. | 
**AppUrl** | **NullableString** |  | 
**CreditLevel** | **NullableString** |  | 
**ReadinessStatus** | **NullableString** |  | 

## Methods

### NewGetFossabotStatus200Response

`func NewGetFossabotStatus200Response(connected bool, statusAvailable bool, appUrl NullableString, creditLevel NullableString, readinessStatus NullableString, ) *GetFossabotStatus200Response`
...
### SetReadinessStatusNil

`func (o *GetFossabotStatus200Response) SetReadinessStatusNil(b bool)`

 SetReadinessStatusNil sets the value for ReadinessStatus to be an explicit nil

### UnsetReadinessStatus
`func (o *GetFossabotStatus200Response) UnsetReadinessStatus()`

UnsetReadinessStatus ensures that no value is present for ReadinessStatus, not even an explicit nil
