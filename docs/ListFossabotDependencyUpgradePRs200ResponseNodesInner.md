...
**FossabotUrl** | **NullableString** | PR detail page in the fossabot app. Null when fossabot did not give one. | 
**State** | **string** |  | 
**AnalysisBadge** | **NullableString** |  | 
**InitiatedByUserId** | **NullableInt32** | FOSSA user id of the initiator; null for automated PRs. | 
**InitiatedByName** | **NullableString** | Display name of the initiator; null for automated PRs and for ids with no user in the calling organization.  | 
**OpenedAt** | **time.Time** |  | 
...
`func (o *ListFossabotDependencyUpgradePRs200ResponseNodesInner) SetFossabotUrlNil(b bool)`

 SetFossabotUrlNil sets the value for FossabotUrl to be an explicit nil

### UnsetFossabotUrl
`func (o *ListFossabotDependencyUpgradePRs200ResponseNodesInner) UnsetFossabotUrl()`
...
GetInitiatedByName returns the InitiatedByName field if non-nil, zero value otherwise.

### GetInitiatedByNameOk

`func (o *ListFossabotDependencyUpgradePRs200ResponseNodesInner) GetInitiatedByNameOk() (*string, bool)`

GetInitiatedByNameOk returns a tuple with the InitiatedByName field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetInitiatedByName sets InitiatedByName field to given value.


### SetInitiatedByNameNil

`func (o *ListFossabotDependencyUpgradePRs200ResponseNodesInner) SetInitiatedByNameNil(b bool)`

 SetInitiatedByNameNil sets the value for InitiatedByName to be an explicit nil

### UnsetInitiatedByName
`func (o *ListFossabotDependencyUpgradePRs200ResponseNodesInner) UnsetInitiatedByName()`

UnsetInitiatedByName ensures that no value is present for InitiatedByName, not even an explicit nil
### GetOpenedAt
