...
> CreateReleaseGroupReleases200Response CreateReleaseGroupReleases(ctx, groupId).CreateReleaseGroupRequestRelease(createReleaseGroupRequestRelease).Execute()
