...
`func (o *Jira) GetCustomFields() map[string]UpdateProjectRequestIssueTrackerCustomFieldsValue`

GetCustomFields returns the CustomFields field if non-nil, zero value otherwise.

### GetCustomFieldsOk

`func (o *Jira) GetCustomFieldsOk() (*map[string]UpdateProjectRequestIssueTrackerCustomFieldsValue, bool)`
...
`func (o *Jira) SetCustomFields(v map[string]UpdateProjectRequestIssueTrackerCustomFieldsValue)`
