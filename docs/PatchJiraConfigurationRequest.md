...
`func (o *PatchJiraConfigurationRequest) SetHeadersNil(b bool)`

 SetHeadersNil sets the value for Headers to be an explicit nil

### UnsetHeaders
`func (o *PatchJiraConfigurationRequest) UnsetHeaders()`
...
`func (o *PatchJiraConfigurationRequest) SetCustomFieldsNil(b bool)`

 SetCustomFieldsNil sets the value for CustomFields to be an explicit nil

### UnsetCustomFields
`func (o *PatchJiraConfigurationRequest) UnsetCustomFields()`
