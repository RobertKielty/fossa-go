...
**RequiredClaims** | Pointer to [**[]CreateOIDCTrustRelationshipRequestOneOfRequiredClaimsInner**](CreateOIDCTrustRelationshipRequestOneOfRequiredClaimsInner.md) | Array of claim objects. Must contain at least one object with claim: \&quot;sub\&quot;. Additional objects with other claims are optional.  | [optional] 
...
`func (o *UpdateOIDCTrustRelationshipRequest) GetRequiredClaims() []CreateOIDCTrustRelationshipRequestOneOfRequiredClaimsInner`

GetRequiredClaims returns the RequiredClaims field if non-nil, zero value otherwise.

### GetRequiredClaimsOk

`func (o *UpdateOIDCTrustRelationshipRequest) GetRequiredClaimsOk() (*[]CreateOIDCTrustRelationshipRequestOneOfRequiredClaimsInner, bool)`
...
`func (o *UpdateOIDCTrustRelationshipRequest) SetRequiredClaims(v []CreateOIDCTrustRelationshipRequestOneOfRequiredClaimsInner)`
