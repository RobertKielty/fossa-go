...
[**GenerateOrganizationScimToken**](OrganizationSettingsAPI.md#GenerateOrganizationScimToken) | **Post** /organizations/{id}/scim/token | 
...
[**GetOrganizationScimStatus**](OrganizationSettingsAPI.md#GetOrganizationScimStatus) | **Get** /organizations/{id}/scim | 
...
[**PutOrganizationBowerSettings**](OrganizationSettingsAPI.md#PutOrganizationBowerSettings) | **Put** /organizations/{id}/settings/languages/bower | 
...
[**RevokeOrganizationScimToken**](OrganizationSettingsAPI.md#RevokeOrganizationScimToken) | **Delete** /organizations/{id}/scim/token | 
...
## GenerateOrganizationScimToken

> GenerateOrganizationScimToken200Response GenerateOrganizationScimToken(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.OrganizationSettingsAPI.GenerateOrganizationScimToken(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `OrganizationSettingsAPI.GenerateOrganizationScimToken``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GenerateOrganizationScimToken`: GenerateOrganizationScimToken200Response
	fmt.Fprintf(os.Stdout, "Response from `OrganizationSettingsAPI.GenerateOrganizationScimToken`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGenerateOrganizationScimTokenRequest struct via the builder pattern
...
[**GenerateOrganizationScimToken200Response**](GenerateOrganizationScimToken200Response.md)
...
> GetOrganizationBowerSettings200Response GetOrganizationBowerSettings(ctx, id).Execute()
...
[**GetOrganizationBowerSettings200Response**](GetOrganizationBowerSettings200Response.md)
...
> GetOrganizationLicensingIssueSettings200Response GetOrganizationLicensingIssueSettings(ctx, id).Execute()
...
> GetOrganizationNugetSettings200Response GetOrganizationNugetSettings(ctx, id).Execute()
...
[**GetOrganizationNugetSettings200Response**](GetOrganizationNugetSettings200Response.md)
...
## GetOrganizationScimStatus

> GetOrganizationScimStatus200Response GetOrganizationScimStatus(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.OrganizationSettingsAPI.GetOrganizationScimStatus(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `OrganizationSettingsAPI.GetOrganizationScimStatus``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetOrganizationScimStatus`: GetOrganizationScimStatus200Response
	fmt.Fprintf(os.Stdout, "Response from `OrganizationSettingsAPI.GetOrganizationScimStatus`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetOrganizationScimStatusRequest struct via the builder pattern
...
[**GetOrganizationScimStatus200Response**](GetOrganizationScimStatus200Response.md)
...
> PropagateOrganizationContainerIssueSettings(ctx, id).RequestBody(requestBody).Execute()
...
> RevokeOrganizationScimToken(ctx, id).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.OrganizationSettingsAPI.RevokeOrganizationScimToken(context.Background(), id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `OrganizationSettingsAPI.RevokeOrganizationScimToken``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiRevokeOrganizationScimTokenRequest struct via the builder pattern
