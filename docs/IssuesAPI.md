...
func main() {
	...
	filterIgnoreReason := []string{"FilterIgnoreReason_example"} // []string | Filter ignored issues by ignore reason (category \"vulnerability\" or \"licensing\"). For vulnerabilities, this value appears in the vulnerabilities.analysis.detail field in CycloneDX SBOM reports.  (optional)
 ...
 **filterIgnoreReason** | **[]string** | Filter ignored issues by ignore reason (category \&quot;vulnerability\&quot; or \&quot;licensing\&quot;). For vulnerabilities, this value appears in the vulnerabilities.analysis.detail field in CycloneDX SBOM reports.  | 
